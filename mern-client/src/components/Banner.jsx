  ...
  return (
    <div className='px-4 lg:px-24 bg-teal-100 flex items-center'>
        ...
        <div className='md:w-1/2 space-y-8 h-full'>
            ...
            <p className='md:w-4/5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur perspiciatis repellat omnis, officia dolore deleniti excepturi sapiente error incidunt odit optio? Ipsum nulla deserunt quia enim. Corporis labore distinctio alias?</p>
            <div>
